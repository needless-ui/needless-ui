...
- [`35a9f70`](https://github.com/needless-ui/needless-ui/commit/35a9f70454ca37684d41508fd2899f66dc525bf3) - - **Select:** on touch screens, where there are no keys to type to jump with, a list of more than 20 options gets a search field above it. It waits for a tap, so the on-screen keyboard doesn't cover the list as it opens. `search` shows it always, never or `'auto'` (the default: touch screens, long lists), and `searchLabel` names it. On a keyboard, a letter typed on the trigger goes into the field.
...
- Updated dependencies [[`35a9f70`](https://github.com/needless-ui/needless-ui/commit/35a9f70454ca37684d41508fd2899f66dc525bf3)]:
  - @needless-ui/css@0.6.2
