    ...
    api: [
      {
        ...
        members: [
          ...
          { name: 'toolbar', kind: 'input', type: "boolean | 'auto'", default: "'auto'" },
    ...
    api: [
      {
        ...
        members: [
          ...
          { name: 'virtual', kind: 'input', type: "boolean | 'auto'", default: "'auto'" },
          { name: 'search', kind: 'input', type: "boolean | 'auto'", default: "'auto'" },
          { name: 'openChange', kind: 'output', type: 'boolean' },
          { name: 'show', kind: 'method', type: '() => void' },
          { name: 'hide', kind: 'method', type: '() => void' },
          { name: 'focus', kind: 'method', type: '(options?: FocusOptions) => void' },
        ],
        texts: ['selectAllLabel', 'clearAllLabel', 'emptyLabel', 'searchLabel'],
      },
      NUI_OPTION,
      ...OPTION_TEMPLATES,
    ],
