...
- **Target size:** the smallest size is 28px, above the WCAG 2.2 minimum of 24px.
- **Forced colors:** the transparent border becomes a visible system-colored border; disabled buttons use `GrayText`.
- **Motion:** color transitions use duration tokens, which collapse under `prefers-reduced-motion`.
